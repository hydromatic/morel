...
public abstract class Tracers {
  ...
  /**
   * Returns a tracer that performs the given action on a declaration, then
   * calls the underlying tracer.
   */
  public static Tracer withOnCore(
      Tracer tracer, int pass, Consumer<Core.Decl> consumer) {
  ...
  /**
   * Returns a tracer that performs the given action on code, then calls the
   * underlying tracer.
   */
  ...
  public static Tracer withOnException(
  ...
  public static Tracer withOnCompileException(
      Tracer tracer, Consumer<CompileException> consumer) {
    return new DelegatingTracer(tracer) {
      @Override
  ...
  public static Tracer withOnTypeException(
      Tracer tracer, Consumer<TypeResolver.TypeException> consumer) {
    return new DelegatingTracer(tracer) {
      @Override
